...
class LocatingTool:
    ...
    def initGui(self):
        ...
        icon_path = self.plugin_dir + '/icon/icon2.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Locate spots for MCC'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = LocatingToolDockWidget(self.iface)
